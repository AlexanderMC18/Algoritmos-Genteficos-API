...
@app.route('/')
def index():
    mejor_gen_resultado = algoritmo_genetico()
    mejor_gen_str = "Mejor gen encontrado: " + str(mejor_gen_resultado[0])
    adaptacion_str = "Función de adaptación: " + str(mejor_gen_resultado[1])
    return render_template('index.html', mejor_gen=mejor_gen_str, adaptacion=adaptacion_str)
